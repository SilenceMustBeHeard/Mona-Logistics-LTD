        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinearMeters = table.Column<double>(type: "double precision", nullable: false),
                    IsFragile = table.Column<bool>(type: "boolean", nullable: false),
                    RequiresCooling = table.Column<bool>(type: "boolean", nullable: false),
                    ...
                    PreferredVehicleType = table.Column<int>(type: "integer", nullable: false),
                    MinCargoSpaceM3 = table.Column<double>(type: "double precision", nullable: false),
                    MaxWeightCapacityKg = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shipments_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SystemMessages_AspNetUsers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SystemMessages_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoadRequestDocument", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LoadRequestDocument_LoadRequests_LoadRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoadRequestDocument_LoadRequestId",
                table: "LoadRequestDocument",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemMessages_SenderId",
                table: "SystemMessages",
                column: "SenderId");
