...
# \[!\[Entity Framework](https://img.shields.io/badge/Entity\_Framework-10.0-512BD4?logo=.net)](https://learn.microsoft.com/en-us/ef/)
...
# &#x20;   "DefaultConnection": "Host=localhost;Port=5432;Database=MonaLogisticsDB;Username=postgres;Password=your\_password"
...
# dotnet user-secrets set "SendGrid:ApiKey" "YOUR\_SENDGRID\_API\_KEY"
...
# &#x20; -e ConnectionStrings\_\_DefaultConnection="Host=postgres;Port=5432;Database=MonaLogisticsDB;Username=postgres;Password=secret" \\

# &#x20; -e ASPNETCORE\_ENVIRONMENT=Production \\
...
# | `ASPNETCORE\_ENVIRONMENT` | Runtime environment (Development/Production) | ✅ |

# | `ConnectionStrings\_\_DefaultConnection` | PostgreSQL connection string | ✅ |

# | `POSTGRES\_DB` | Database name (for docker-compose) | ✅ |

# | `POSTGRES\_USER` | Database user (for docker-compose) | ✅ |

# | `POSTGRES\_PASSWORD` | Database password (for docker-compose) | ✅ |
...
# ConnectionStrings\_\_DefaultConnection=Host=ep-shy-block-...;Database=neondb;Username=neondb\_owner;Password=...;SSL Mode=Require
...
# \- \[Open an issue](https://github.com/SilenceMustBeHeard/Mona-Logistics-LTD/issues)

# \- Email: support@monalogistics.com
